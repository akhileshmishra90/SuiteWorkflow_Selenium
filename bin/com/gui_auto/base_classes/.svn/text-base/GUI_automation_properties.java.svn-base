...
public class GUI_automation_properties {
	...
	public final static String DSFURL = "DSFURL";
	...
	public static final String VBSFileP = "VBSFileP";
	public static final String Mobile = "Mobile";
	public static final String STOREFRONT = "STOREFRONT";
	public static final String sSpecialChars = "sSpecialChars";
	public static final String sAlphaNumeric = "sAlphaNumeric";
	public static final String sMaxChars = "sMaxChars";
	...
	public boolean setProperty(final String key, final String Value) {
		_gui_automation_properties.setProperty(key, Value);
		String property = _gui_automation_properties.getProperty(key);
